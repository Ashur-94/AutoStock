...
export const INITIAL_STOCK_ITEMS: StockItem[] = [
  {
    ...
    costPrice: 24.50,
    sellingPrice: 38.00,
    location: 'المسار 1 - رف الزيوت أ',
    supplier: 'شركة الأوتوزون التجارية',
    lastUpdated: '2026-08-18T14:30:00Z',
    notes: 'صنف سريع الدوران، معيار تغيير الزيت التخليقي القياسي'
  },
  {
    id: 'stk-002',
    ...
    category: 'زيوت وسوائل',
    imageUrl: 'https://images.unsplash.com/photo-1596568359553-a56de6970068?w=600&auto=format&fit=crop&q=80',
    quantity: 4,
    minStockThreshold: 5,
    unit: 'جالون',
    costPrice: 23.00,
    sellingPrice: 36.50,
    location: 'المسار 1 - رف الزيوت ب',
    supplier: 'شركة الأوتوزون التجارية',
    lastUpdated: '2026-08-15T09:15:00Z',
    notes: 'شائع لمحركات تويوتا وهوندا الحديثة'
  },
  {
    id: 'stk-003',
    ...
    sellingPrice: 11.99,
    location: 'الرف ب-2',
    supplier: 'موزع قطع الغيار نابّا',
    lastUpdated: '2026-08-17T11:20:00Z',
    notes: 'متوافق مع محركات هوندا، نيسان، وسوبارو 4 سلندر'
  },
  {
    id: 'stk-004',
    partNumber: 'FRAM-CA10190',
    name: 'فلتر هواء المحرك فرام إكسترا غارد CA10190',
    category: 'فلاتر وترشيح',
  ...
  },
  {
    ...
    costPrice: 34.00,
    sellingPrice: 62.00,
    location: 'خزانة الفرامل يسار',
    supplier: 'شركة وورلد باك للفرامل',
    lastUpdated: '2026-08-19T13:45:00Z',
    notes: 'تركيبة سيراميك قليلة الغبار مع شرائح التثبيت'
  },
  {
    id: 'stk-006',
    ...
    costPrice: 68.00,
    sellingPrice: 115.00,
    location: 'الرف السفلي للقطع الثقيلة أ',
    supplier: 'شركة وورلد باك للفرامل',
    lastUpdated: '2026-08-16T10:00:00Z',
    notes: 'تنبيه: مخزون منخفض جداً بحاجة للطلب'
  },
  {
    id: 'stk-007',
    partNumber: 'DOT4-BRAKE-32OZ',
    name: 'زيت فرامل بريستون DOT 4 عالي الحرارة (32 أونصة)',
    category: 'زيوت وسوائل',
    imageUrl: 'https://images.unsplash.com/photo-1615906655593-ad0386982a0f?w=600&auto=format&fit=crop&q=80',
    quantity: 9,
    minStockThreshold: 4,
    ...
    costPrice: 6.20,
    sellingPrice: 12.50,
    location: 'المسار 2 - خزانة السوائل',
    supplier: 'موزع قطع الغيار نابّا',
    lastUpdated: '2026-08-12T15:10:00Z'
  },
  {
    id: 'stk-008',
    ...
    costPrice: 28.00,
    sellingPrice: 48.00,
    location: 'درج القطع الكهربائية 3',
    supplier: 'بوش وكهرباء السيارات',
    lastUpdated: '2026-08-14T08:30:00Z'
  },
  {
    id: 'stk-009',
    ...
    category: 'بطاريات',
    imageUrl: 'https://images.unsplash.com/photo-1592853625597-7d17be820d0c?w=600&auto=format&fit=crop&q=80',
    quantity: 3,
    minStockThreshold: 3,
    unit: 'قطعة',
    costPrice: 135.00,
    sellingPrice: 195.00,
    location: 'منصة البطاريات المركزية',
    supplier: 'بطاريات إنترستيت وبوش',
    lastUpdated: '2026-08-19T17:00:00Z',
    notes: 'قدرة تدوير 650 CCA، ضمان استبدال 36 شهراً'
  },
  {
    id: 'stk-010',
    partNumber: 'CONT-4060825',
    name: 'سير محرك سيربنتين كونتيننتال متعدد الأضلاع (82.5 إنش)',
    category: 'سيور وخراطيم',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1585670270606-d7a8d56b0933?w=600&auto=format&fit=crop&q=80',
    quantity: 18,
    minStockThreshold: 12,
    unit: 'علبة بخاخ',
    costPrice: 3.65,
    sellingPrice: 6.99,
    location: 'خزانة الكيماويات - المسار 1',
    supplier: 'موزع قطع الغيار نابّا',
    lastUpdated: '2026-08-18T16:00:00Z',
    notes: 'مستلزم يومي أساسي للورشة'
  },
  {
    id: 'stk-012',
    partNumber: 'MOOG-K500063',
    name: 'جوزة مقص أمامي سفلي موج بروبلم سولفر',
    category: 'نظام تعليق وتوجيه',
    ...
    costPrice: 22.00,
    sellingPrice: 44.00,
    location: 'رف التعليق ج',
    supplier: 'شركة وورلد باك للفرامل',
    lastUpdated: '2026-08-09T14:20:00Z'
  },
  {
    id: 'stk-013',
    partNumber: 'SCOTT-TOWEL-12PK',
    name: 'مناشف ورشة زرقاء متينة سكوت برو (طرد 12 رول)',
    category: 'مواد ومستلزمات الورشة',
