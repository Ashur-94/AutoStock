...
export const LowStockBanner: React.FC<LowStockBannerProps> = ({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 mt-3 sm:mt-4">
      <div className="bg-gradient-to-r from-rose-50 via-white to-amber-50 border border-rose-300 rounded-2xl text-slate-900 px-3.5 sm:px-6 py-2.5 sm:py-3 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 sm:gap-3 w-full">
          ...
          <div className="flex items-start sm:items-center gap-2.5 sm:gap-3 min-w-0 w-full sm:w-auto">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-rose-100 border border-rose-300 flex items-center justify-center text-rose-700 shrink-0 animate-pulse mt-0.5 sm:mt-0">
          ...
          <div className="flex items-center gap-2 self-stretch sm:self-auto justify-start sm:justify-end shrink-0 w-full sm:w-auto pt-1 sm:pt-0 border-t border-rose-200 sm:border-0">
            <button
              id="view-low-stock-items-btn"
              onClick={onFilterLowStock}
              className="flex-1 sm:flex-initial px-3 py-1.5 rounded-lg bg-rose-100 hover:bg-rose-200 text-rose-800 border border-rose-300 text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors cursor-pointer whitespace-nowrap"
            >
